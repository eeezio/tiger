...
public class PrettyPrintVisitor implements Visitor {
    ...
    public void visit(MethodSingle m) {
        sayln("struct " + m.id + "_gc_frame{");
        indent();
        saylnWithSpace("void *prev;");
        ...
        saylnWithSpace("struct " + m.id + "_gc_frame frame;");
        saylnWithSpace("frame.prev=prev;");
        saylnWithSpace("prev=&frame;");
        ...
        for (String localName : localRefVar)
            saylnWithSpace("frame." + localName + "=" + localName + ';');

        this.sayln("");
        for (Stm.T s : m.stms)
            s.accept(this);
        saylnWithSpace("prev=frame.prev;");
        this.say("  return ");
