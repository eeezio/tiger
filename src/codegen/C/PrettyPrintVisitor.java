...
public class PrettyPrintVisitor implements Visitor {
    ...
    public void visit(ArraySelect e) {
        ...
        this.say("[");
        e.index.accept(this);
        this.say("+6");//array对象模型头部占了24个字节，为6个int。
        this.say("]");
    }
    ...
    public void visit(MethodSingle m) {
        ...
        HashSet<String> localRefVar = searchMethodRefVar(m.locals);
        unIndent();
        sayln("};");
        ...
        saylnWithSpace("frame.length=" + (argsRefVar.size() + localRefVar.size()) + ";");
...
//        saylnWithSpace("printf(\"exit func"+m.id+" return to gc_frame address: %x \\n\",gc_frame_prev);");
        this.say("  return ");
    ...
    public void visit(MainMethodSingle m) {
        sayln("struct Tiger_main" + "_gc_frame{");
        indent();
        saylnWithSpace("double length;");
        saylnWithSpace("void *gc_frame_prev;");
        HashSet<String> localRefVar = searchMethodRefVar(m.locals);
        ...
        saylnWithSpace("struct Tiger_main_gc_frame frame;");
        saylnWithSpace("frame.gc_frame_prev=gc_frame_prev;");
        saylnWithSpace("gc_frame_prev=&frame;");
        saylnWithSpace("frame.length=" + localRefVar.size() + ";");
//        saylnWithSpace("printf(\"enter func Tiget_main gc_frame address: %x    ref_var_num:%lf\\n\",gc_frame_prev,frame.length);");;
        printSpaces();
        sayln("vtableInit();");
