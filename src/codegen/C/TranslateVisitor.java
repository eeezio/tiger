...
public class TranslateVisitor implements ast.Visitor {
    ...
    public void visit(ast.Ast.Exp.Add e) {
        ...
        Exp.T left = this.exp;
        e.right.accept(this);
        this.exp = new Exp.Add(left, this.exp);
    }
    ...
    public void visit(ast.Ast.Exp.And e) {
        ...
        Exp.T left = this.exp;
        e.right.accept(this);
        this.exp = new Exp.And(left, this.exp);
    }
    ...
    public void visit(ast.Ast.Exp.ArraySelect e) {
        ...
        e.index.accept(this);
        this.exp = new Exp.ArraySelect(array, this.exp);
    }
    ...
    //为什么在codegen的AST中，exp中的True和False都找不到了？原因是C语言中没有bool类型。
    @Override
    ...
    public void visit(ast.Ast.Stm.AssignArray s) {
        ...
        Exp.T exp = this.exp;
        s.index.accept(this);
        this.stm = new Stm.AssignArray(s.id, this.exp, exp);
    }
    ...
    public void visit(ast.Ast.Stm.While s) {
        ...
        Exp.T condition = this.exp;
        s.stm.accept(this);
        this.stm = new Stm.While(condition, this.stm);
    }
